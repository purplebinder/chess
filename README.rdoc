...
3. You are moving the other player's piece.  
4. The board knows whose turn it is, and will only let you move pieces of that color.
5. The piece in question cannot jump (i.e. anything but a knight) and there is no direct
6. path between the start and end positions.
